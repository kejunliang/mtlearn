import { Component, OnInit } from '@angular/core';
  ...
  export class LoadmoreDatabase {
    ...
    /** The data */
    rootLevelNodes: string[] = ['分组1', 'Fruits'];
    dataMap = new Map<string, string[]>([
      ['Fruits', ['Apple', 'Orange', 'Banana']],
      ['分组1', ['Tomato', 'Potato', 'Onion']],
...
@Component({
  selector: 'app-chailist',
  templateUrl: './chailist.component.html',
  styleUrls: ['./chailist.component.css'],
  providers: [LoadmoreDatabase]
})
export class ChailistComponent implements OnInit {
